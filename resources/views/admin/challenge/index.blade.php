@extends('layouts.admin_app')
    @section("site-title", "Challenges")
    @section("main-content-title", "Challenges")
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                <label for="filter_challenge_id">Challenge ID</label>
                                                <input type="text" class="form-control newmeric" placeholder="Challenge ID" id="filter_challenge_id" name="filter_challenge_id" maxlength="10">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                <label for="filter_name">Name</label>
                                                <input type="text" class="form-control alphabates" placeholder="Name " id="filter_name" name="filter_name" maxlength="40">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                <label for="filter_challenge">Challenge</label>
                                                <input type="text" class="form-control alphanewmeric" placeholder="Challenge" id="filter_challenge" name="filter_challenge" maxlength="50">
                                            </div>
                                        </div>
