@extends('layouts.admin_app')
    @section("site-title", "Category Management")
    @section("main-content-title", "Category Management")
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                <label for="filter_cat_name">Category Name</label>
                                                <input type="text" class="form-control alphabates" placeholder="Category Name" id="filter_cat_name" name="filter_cat_name" maxlength="50">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                <label for="filter_price">Category Price</label>
                                                <input type="text" class="form-control newmwric" placeholder="Category Price" id="filter_price" name="filter_price" maxlength="10">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row">
