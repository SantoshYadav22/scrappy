@extends('layouts.admin_app')
    @section("site-title", "Product Management")
    @section("main-content-title", "Product Management")
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                <label for="filter_product">Product ID</label>
                                                <input type="text" class="form-control newmeric" placeholder="Product ID" id="filter_product" name="filter_product" maxlength="30">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                <label for="filter_cat_id">Caterogy ID</label>
                                                <input type="text" class="form-control newmwric" placeholder="Caerogy ID" id="filter_cat_id" name="filter_cat_id" maxlength="10">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                <label for="filter_pro_name">Product Name</label>
                                                <input type="text" class="form-control alphanewmeric" placeholder="Product Name" id="filter_pro_name" name="filter_pro_name" maxlength="50">
                                            </div>
                                        </div>
